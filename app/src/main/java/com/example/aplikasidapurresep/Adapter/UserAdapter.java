...
import com.example.aplikasidapurresep.MainActivity;
import com.example.aplikasidapurresep.Model.User;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(user.getImage_url()).into(holder.image_profil);
